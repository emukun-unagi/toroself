...
module.exports = {
  ...
  run: async function (client, message, args) {
    ...
    if(parseInt(args[0]) > 1000 ||(args[0]) < 0) return sendError('You can\'t set the volume more than 150. or lower than 0',message.channel).catch(err => console.log(err));
    ...
    .setColor("#00ffff")
    return message.channel.send(`I set the volume to: **\`${args[0]/1}/100\`**`);
  },
};
